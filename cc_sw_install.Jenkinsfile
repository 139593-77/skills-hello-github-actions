          ...
          if (software in jsonRequiredSoftwares){
            ...
            writeFile (file: "${WORKSPACE}/install_uninstall.json" ,
                  ...
                  {"wib_devops": {
                        ...
                        "install_uninstall": {
                            "current_json_file_name": "install_uninstall.json",
                            "artifactory_service_account": "SRV-WIB-DEVOPS",
                            "source_databag_srv_act": "SRV-WIB-DEVOPS",
                            "source_databag_loc": "a004cf-prd-secrets.json",
                            ...
                            "local_devops_sql_logs_path": "${drive}/devops/sql_logs",
                            "local_encryption_keys_path": "${drive}/devops/encryption_keys",
                            "local_devops_windows_softwares_path": "E:/devops/windows_softwares",
                            "source_artifactory_json_file_loc": "https://artifactory.srv.westpac.com.au/artifactory/A004CF_RMW/attributes_npr/install_uninstall.json",
                            ...
                            "7zip": {
                                "art_link": "https://artifactory.srv.westpac.com.au/artifactory/A004CF_SQL_SNAP/Softwares/7z2408-x64.exe",
                                "package_name": "7z2408-x64.exe",
                                "package_type": "exe",
                                "options_list": "/S /D=\\"C:/Program Files/7-Zip\\""
                            },
                            "Notepad++": {
